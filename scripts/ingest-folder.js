...
const CATEGORY_RULES = [
  ...
  ['storage-shelf', ['estanteria-con-2-armarios', 'estanteria con 2 armarios', 'estanterÃ­a con 2 armarios', 'estanteria-con-armario', 'estanteria con armario', 'estanterÃ­a con armario', 'estanteria-de-interior-y-exterior', 'estanteria de interior y exterior', 'estanterÃ­a de interior y exterior']],
  ['outdoor-cabinet', ['armario-para-interior-o-exterior', 'armario para interior o exterior']],
  ['outdoor-storage', ['mueble-de-almacenaje', 'mueble de almacenaje']],
  ['outdoor-bench', ['banco-con-respaldo-de-exterior', 'banco con respaldo de exterior', 'banco-jardin', 'banco jardin', 'banco jardÃ­n']],
  ['outdoor-stool', ['taburete-de-exterior', 'taburete de exterior']],
  ['privacy-screen', ['pantalla-para-privacidad', 'pantalla para privacidad', 'caja-y-pantalla-privacidad', 'caja y pantalla privacidad']],
  ['deck-box', ['baul', 'baÃºl', 'deck-box']],
  ['outdoor-chair', ['silla-con-reposabrazos-exterior', 'silla con reposabrazos exterior']],
  ['outdoor-table', ['mesa-de-centro-exterior', 'mesa de centro exterior', 'mesa de centro - exterior', 'mesa-de-centro-exterior-interior', 'mesa de centro exterior interior']],
  ['outdoor-sofa', ['sofa-2-plazas-exterior', 'sofa 2 plazas exterior', 'sofÃ¡ 2 plazas exterior', 'sofa-de-2-plazas-exterior', 'sofa de 2 plazas exterior']],
  ['outdoor-box', ['caja exterior', 'outdoor box']],
  ['lounge-chair', ['silla-giratoria-y-reposapies', 'silla giratoria y reposapies', 'silla giratoria y reposapiÃ©s', 'silla-giratoria', 'silla giratoria', 'sillon-y-reposapies', 'sillon y reposapies', 'sillÃ³n y reposapiÃ©s']],
  ['pouf', ['puf', 'pouf']],
  ['footstool', ['reposapies', 'reposapiÃ©s', 'footstool']],
  ...
  ['cabinet', ['armario-con-puertas-correderas', 'armario con puertas correderas', 'cabinet']],
